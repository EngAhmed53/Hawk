...
import com.shouman.apps.hawk.ui.main.companyUi.navDrawer.home.Fragment_home;
...
//        Fragment_home fragment_companyhome = (Fragment_home) fragmentManager.findFragmentByTag("all_sales_members");
//        if (fragment_companyhome == null) {
//            fragment_companyhome = Fragment_home.getInstance();
//            fragmentManager.beginTransaction().add(R.id.home_container, fragment_companyhome, "all_sales_members").commit();
//        }
//    }
//
