package com.shouman.apps.hawk.ui.main.companyUI.navDrawer.home.branchInfo;
...
public class Fragment_branch_info extends Fragment {
    ...
    private void setUI() {
        ...
        mBinding.branchTitleSmallTxt.setText(branchName);
        mBinding.countryTxt.setText("Egypt");
        mBinding.cityTxt.setText("Cairo");
