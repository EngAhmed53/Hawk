package com.shouman.apps.hawk.ui.main.companyUI.navDrawer.home.addNewSalesman;
...
public class Fragment_new_salesman extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        homeViewModel.getAllBranchesDetails().observe(getViewLifecycleOwner(), (branchesDetails) -> {
            ...
            branchesAdapter = new DropDownArrayAdapter(requireContext(), allBranchesNames);
    ...
    private Uri buildDeepLink() {
        ...
        builder.scheme("https")
                ...
                .appendPath(UserPreference.getInstance().getCompanyUID(requireContext()))
